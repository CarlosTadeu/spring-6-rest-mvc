...
class CustomerControllerTest {
    ...
    void patchCustomer() throws Exception {
        ...
        mockMvc.perform(patch(CustomerController.API_V1_CUSTOMER + "/" + customer.getId())
    ...
    void deleteBeerById() throws Exception {
        ...
        mockMvc.perform(delete(CustomerController.API_V1_CUSTOMER + "/" + customer.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());
    ...
    void updateCustomerById() throws Exception {
        ...
        mockMvc.perform(put(CustomerController.API_V1_CUSTOMER + "/" + customer.getId())
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void createNewCustomer() throws Exception {
        ...
        mockMvc.perform(post(CustomerController.API_V1_CUSTOMER)
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void getCustomerById() throws Exception {
        ...
        mockMvc.perform(get(CustomerController.API_V1_CUSTOMER + "/" + testCustomer.getId())
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
