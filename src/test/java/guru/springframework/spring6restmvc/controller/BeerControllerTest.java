...
class BeerControllerTest {
    ...
    void patchBeer() throws Exception {
        ...
        mockMvc.perform(patch(BeerController.API_V1_BEER + "/" + beer.getId())
    ...
    void deleteBeerById() throws Exception {
        ...
        mockMvc.perform(delete(BeerController.API_V1_BEER + "/" + beer.getId())
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());
    ...
    void updateBeerById() throws Exception {
        ...
        mockMvc.perform(put(BeerController.API_V1_BEER + "/" + beer.getId())
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get(BeerController.API_V1_BEER + "/" + testBeer.getId())
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
